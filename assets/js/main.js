...
function myFunction7() {
  ...
  var btn7Text = document.getElementById("myBtn7");

  if (dots.style.display === "none") {
    dots.style.display = "inline";
    btn7Text.innerHTML = "Read more";
    moreText.style.display = "none";
  } else {
    dots.style.display = "none";
    btn7Text.innerHTML = "Read less";
    moreText.style.display = "inline";
  }
}
...
function myFunction8() {
  ...
  var btn8Text = document.getElementById("myBtn8");

  if (dots.style.display === "none") {
    dots.style.display = "inline";
    btn8Text.innerHTML = "Read more";
    moreText.style.display = "none";
  } else {
    dots.style.display = "none";
    btn8Text.innerHTML = "Read less";
    moreText.style.display = "inline";
  }
}
